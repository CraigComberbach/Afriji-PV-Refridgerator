...
int main(void)
{
	...
	Schedule_Task(INVERTER_STARTUP_TASK,&Energize,			1001000/*uS Delay*/,	50000/*uS Period*/,		120/*Repetitions*/);
	...
	Schedule_Task(FREQUENCY_RAMP_TASK,	&Frequency_Ramp,	2500000/*uS Delay*/,	1000000/*uS Period*/,	40/*Repetitions*/);
