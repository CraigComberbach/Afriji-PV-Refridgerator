...
look into me	AD1CON3bits.ADCS = 0b111111;	//111111 = 64 * TCY
look into me	AD1CON3bits.SAMC = 0b11111;		//11111 = 31 TAD
look into me	AD1CON3bits.ADRC = 1;			//1 = A/D internal RC clock
